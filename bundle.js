...
var _bmpfont = __webpack_require__(5);

var bmpfont = _interopRequireWildcard(_bmpfont);
...
context.drawBitmapText('fonts/arial-32', 'Hello Hugo!', 0, 20, 500, 500, tf);
...
exports.getDefaultTextFormat = getDefaultTextFormat;
exports.drawText = drawText;
var createLayout = __webpack_require__(6);
...
function render(layout, context, image, offsetx, offsety, width, height, color) {
  ...
  layout.glyphs.forEach(function (glyph) {
    ...
    var _glyph$position = _slicedToArray(glyph.position, 2),
        x = _glyph$position[0],
        y = _glyph$position[1];
    ...
    if (bitmap.width * bitmap.height === 0) return;

    //draw the sprite from texture atlas
    context.save();

    context.globalCompositeOperation = "";
    context.drawImage(image, bitmap.x, bitmap.y, bitmap.width, bitmap.height, x + bitmap.xoffset, y + bitmap.yoffset, bitmap.width, bitmap.height);
...
//
function drawText(context, font, text, x, y, width, height, textFormat) {

  return new Promise(function (resolve, reject) {
    if (textFormat == null) textFormat = getDefaultTextFormat();
...
var wordWrap = __webpack_require__(7)
...
/* WEBPACK VAR INJECTION */(function(Buffer) {var xhr = __webpack_require__(13)
var noop = function(){}
var parseASCII = __webpack_require__(18)
var parseXML = __webpack_require__(19)
var readBinary = __webpack_require__(22)
...
var parseAttributes = __webpack_require__(20)
var parseFromString = __webpack_require__(21)
...
/* WEBPACK VAR INJECTION */(function(Buffer) {var equal = __webpack_require__(24)
...
var Buffer = __webpack_require__(1).Buffer; // for use with browserify
